...
% This rewriting in terms of an average over auxiliary random choices can be helpful for gaining intuition or generalizing expressions.
...
Principal components can be found, equivalently, as
...
% PLR: I don't think there's anything meaningful in the order these PCs happened to sort in.
...
% which captures deeper ancestry than the pedigree, % PLR: it can't be this because we recapitate with a randomly mating population
...
Next, we explored how the branch relatedness of a given pair of individuals
...
\subsubsection{Computation of the entire branch GRM}
